...
export function addTaskToProject(projectId, taskName, description, priority = 1, dueDate, complete = false) {
    const project = projects.find(p => p.projectId === projectId);

    if (project) {
        const newTask = new Task(taskName, undefined, description, priority, dueDate);
